...
class HumanoidGetUpCfg(BaseConfig):
    ...
    class terrain:
        ...
        #else: plane
        terrain_proportions = [0.0, 0.7, 0.0, 0.0, 0.0, 0.3]
        # trimesh only:
        slope_treshold = (
        ...
        slope_max = 0.2
        stairs_height_range = [0.01, 0.03]
        stairs_width_range = [0.3, 0.42]
        discrete_obstacles_height_range = [0.01, 0.03]
    ...
    class commands():
        ...
        class ranges():
            ...
            lin_vel_x = [-0.0, 0.0]  # min max [m/s] 0.4
            lin_vel_y = [-0.0, 0.0]  # min max [m/s]
            ang_vel_yaw = [-0.0, 0.0]  # min max [rad/s]0.5
            angle_pitch = [-0.2, 0.2]
            angle_roll = [-0.2, 0.2]
    ...
    class control:
        # PD gains reference: unitree_rl_gym (G1 12dof legs) + unitree_rl_lab (G1 23dof arms/waist)
        control_type = {
            "hip_pitch": "P",
            "hip_roll": "P",
            "hip_yaw": "P",
        ...
        # G1 standard: 0.25 (unitree_rl_gym). Smaller for arms/waist due to lower gear ratios.
        action_scale = {
            "hip_pitch": 0.25,
            "hip_roll": 0.25,
            "hip_yaw": 0.25,
    ...
    class asset:
        file = "{GETUP_GYM_ROOT_DIR}/getup_gym/robots/g1/g1_23dof.urdf"
        name = "g1_23dof"
        ...
        left_hip_joints = ["left_hip_yaw_joint", "left_hip_roll_joint"]
        right_hip_joints = ["right_hip_yaw_joint", "right_hip_roll_joint"]
        ...
        hands_names = ["left_wrist_roll_rubber_hand", "right_wrist_roll_rubber_hand"]
    ...
    class domain_rand:
        ...
        push_robots = True
        push_start_epoch = 00
        push_interval_min_s: float = 1.0   # min interval [s]
        push_interval_max_s: float = 5.0   # max interval [s]
        max_push_vel_x = 0.5
        max_push_vel_y = 0.5
        max_push_vel_z = 0.2
        ...
        joint_name_need_strength_rand = ["hip_pitch_l_joint", "hip_pitch_r_joint"]
        motor_strength_range = [0.9, 0.98]

        add_mass_ranges = True
        add_mass_range_x = {"upper": 0.025, "lower": -0.025}
        add_mass_range_y = {"upper": 0.05, "lower": -0.05}
        add_mass_range_z = {"upper": 0.05, "lower":  -0.05}
        ...
        #rigid body randm
        randomize_rigid_body_mass = True
        rigid_body_mass_scale_range = (0.7, 1.3)
        
        randomize_joint_default_pos = True
        default_change_rate = 0.01
    ...
    class rewards:
        ...
        class reward_group_4:
            ...
            rew_right_foot_displacement = 1.0
            pen_shank_orientation_l2 = 0.5
            track_base_height_exp = 4.0
...
class HumanoidGetUpPPO(BaseConfig):
    ...
    class runner:
        ...
        policy_class_name = "ActorCritic"  # "ActorCritic", "Actor_MutiCritic", "MoeActorCritic", "ResNetActorCritic"
